...
from provided.pcodec import Encode, Decode    # module where the actual PAC coding functions reside(this module only specifies the PAC file format)
...
class PACFile(AudioFile):
    ...
    def Encode(self,data,codingParams):
        ...
        return Encode(data,codingParams)
    ...
    def Decode(self,scaleFactor,bitAlloc,mantissa, overallScaleFactor,codingParams):
        ...
        return Decode(scaleFactor,bitAlloc,mantissa, overallScaleFactor,codingParams)
